...
* 
* Output files:                                                   
* - /mnt/data/SDTMBLIND/supplb.sas7bdat
* - /mnt/data/SDTMUNBLIND/supplb.sas7bdat
*
* Macros: 
* - NA
*
...
libname xpt xport '/mnt/imported/data/CDISC01_RAW/supplb.xpt'; * substitute in the filename;
