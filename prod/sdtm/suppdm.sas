...
* 
* Output files:                                                   
* - /mnt/data/SDTMBLIND/suppdm.sas7bdat
* - /mnt/data/SDTMUNBLIND/suppdm.sas7bdat
*
* Macros: 
* - NA
*
...
libname xpt xport '/mnt/imported/data/CDISC01_RAW/suppdm.xpt'; * substitute in the filename;
