...
* 
* Output files:                                                   
* - /mnt/data/SDTMBLIND/suppds.sas7bdat
* - /mnt/data/SDTMUNBLIND/suppds.sas7bdat
*
* Macros: 
* - NA
*
...
libname xpt xport '/mnt/imported/data/CDISC01_RAW/suppds.xpt'; * substitute in the filename;
